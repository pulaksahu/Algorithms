...
namespace ConsoleApplication4
{
    public class MaxHeap
    {
        ...
        {
            while (GetLargestChildIndex(currentIndex) != -1
                    && data[currentIndex] < data[GetLargestChildIndex(currentIndex)])
            {
                int largestChildIndex = GetLargestChildIndex(currentIndex);
                SwapIndices(ref currentIndex, ref largestChildIndex);
